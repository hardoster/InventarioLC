...
@section('title', 'Equipos por Categorías - Sistema de Inventario')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 mb-2">Equipos por Tipo</h1>
                    <p class="text-gray-600">Vista organizada del inventario por tipo de equipo</p>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white rounded-3xl shadow-xs border border-gray-200 p-6">
                ...
                <p class="text-2xl font-bold text-gray-900">${{ number_format($valorTotal, 2) }}</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-3xl shadow-xs border border-gray-200 p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <a href="{{ route('equipos.detalle_tipo', $item->equipo) }}" 
                   class="group block p-6 rounded-2xl border-2 border-gray-100 hover:border-blue-200 hover:shadow-sm transition-all duration-300">
